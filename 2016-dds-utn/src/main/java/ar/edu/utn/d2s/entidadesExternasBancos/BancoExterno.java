...
//		List<PuntoDeInteres> pdiSuc = new ArrayList<PuntoDeInteres>();
...
//			this.repoSuc.agregarPDI(unaSucursal);
//			pdiSuc.add(unaSucursal);
//		}
//		return pdiSuc;
//	}
...
//    public List<PuntoDeInteres> pasarPDI (String unPDI){
