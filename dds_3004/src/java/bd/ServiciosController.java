...
public class ServiciosController implements Serializable {
    ...
    private ServiciosJpaController jpaController = null;
    ...
    private ServiciosJpaController getJpaController() {
        if (jpaController == null) {
            jpaController = new ServiciosJpaController(Persistence.createEntityManagerFactory("dds_3004PU"));
        }
        ...
        if (pagination == null) {
            pagination = new PaginationHelper(10) {
                ...
                public int getItemsCount() {
                    return getJpaController().getServiciosCount();
                }

                @Override
                public DataModel createPageDataModel() {
                    return new ListDataModel(getJpaController().findServiciosEntities(getPageSize(), getPageFirstItem()));
                }
            };
        }
        return pagination;
    ...
    private void performDestroy() {
        try {
            getJpaController().destroy(current.getCodigoServicio());
    ...
    private void updateCurrentItem() {
        int count = getJpaController().getServiciosCount();
        ...
        if (selectedItemIndex >= 0) {
            current = getJpaController().findServiciosEntities(1, selectedItemIndex).get(0);
        }
    }
    ...
    public SelectItem[] getItemsAvailableSelectMany() {
        return JsfUtil.getSelectItems(getJpaController().findServiciosEntities(), false);
    }

    public SelectItem[] getItemsAvailableSelectOne() {
        return JsfUtil.getSelectItems(getJpaController().findServiciosEntities(), true);
    }
    ...
    public static class ServiciosControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getJpaController().findServicios(getKey(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Servicios) {
                ...
                return getStringKey(o.getCodigoServicio());
            } else {
