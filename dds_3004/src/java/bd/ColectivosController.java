...
public class ColectivosController implements Serializable {
    ...
    private ColectivosJpaController getJpaController() {
        if (jpaController == null) {
            jpaController = new ColectivosJpaController(Persistence.createEntityManagerFactory("dds_3004PU"));
        }
        ...
        if (pagination == null) {
            pagination = new PaginationHelper(10) {
                ...
                public int getItemsCount() {
                    return getJpaController().getColectivosCount();
                }

                @Override
                public DataModel createPageDataModel() {
                    return new ListDataModel(getJpaController().findColectivosEntities(getPageSize(), getPageFirstItem()));
                }
            };
        }
        return pagination;
    ...
    private void performDestroy() {
        try {
            getJpaController().destroy(current.getColectivoId());
    ...
    private void updateCurrentItem() {
        int count = getJpaController().getColectivosCount();
        ...
        if (selectedItemIndex >= 0) {
            current = getJpaController().findColectivosEntities(1, selectedItemIndex).get(0);
        }
    }
    ...
    public SelectItem[] getItemsAvailableSelectMany() {
        return JsfUtil.getSelectItems(getJpaController().findColectivosEntities(), false);
    }

    public SelectItem[] getItemsAvailableSelectOne() {
        return JsfUtil.getSelectItems(getJpaController().findColectivosEntities(), true);
    }
    ...
    public static class ColectivosControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getJpaController().findColectivos(getKey(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Colectivos) {
                ...
                return getStringKey(o.getColectivoId());
            } else {
